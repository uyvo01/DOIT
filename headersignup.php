...
echo "<table style='width:400px'><tr>
    ...
    <tr>
        <td style='text-align:right'><font color='RED'>Birth Day*</font></td>
        <td style='text-align:center'><input type='date' class='textbox' id='birth_day' name='birth_day' value=''></td>
    </tr>
    <tr>
        <td style='text-align:right'><font color='RED'>Primary Phone*</font></td>
        <td style='text-align:center'><input type='text' class='textbox' id='phone_no' name='phone_no' value=''></td>
    </tr>
            <tr>
            ...
            <tr>
                ...
                <td style='text-align:center'><input type='text' class='textbox' id='state' name='state' value=''></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <tr>
                    <td style='text-align:right'><font color='RED'>Email*</font></td>
